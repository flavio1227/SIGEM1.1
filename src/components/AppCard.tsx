...
export function AppCard({ app }: AppCardProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className="group relative aspect-square bg-white/95 backdrop-blur-sm rounded p-3 sm:p-4 border border-slate-300 hover:bg-white hover:border-slate-400 flex flex-col items-center justify-center gap-1.5 sm:gap-2 transition-all active:scale-95 shadow-lg hover:shadow-xl"
